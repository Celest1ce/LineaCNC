...
const config = {
    ...
    files: [
        ...
        'tools/mesh-viewer/color-scale.js',
        'tools/mesh-viewer/stats.js',
        'tools/mesh-viewer/parsers.js',
        'tools/mesh-viewer/model.js',
        'tools/mesh-viewer/heatmap.js',
        'tools/mesh-viewer/renderer.js',
        'tools/mesh-viewer/ui.js',
        'views/machine-tile-view.js',
        'views/machine-manager-view.js',
        'components/machine-manager.js',
        'pages/dashboard.js',
        'pages/mesh-viewer.js',
        'main.js'
    ],
